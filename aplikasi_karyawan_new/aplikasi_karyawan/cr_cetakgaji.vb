...
Public Class cr_cetakgaji
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "aplikasi_karyawan.cr_cetakgaji.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcr_cetakgaji
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cr_cetakgaji = New cr_cetakgaji
        rpt.Site = Me.Site
        Return rpt
    End Function
