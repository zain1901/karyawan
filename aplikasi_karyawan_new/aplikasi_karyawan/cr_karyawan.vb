...
Public Class cr_karyawan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "aplikasi_karyawan.cr_karyawan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcr_karyawan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cr_karyawan = New cr_karyawan
        rpt.Site = Me.Site
        Return rpt
    End Function
